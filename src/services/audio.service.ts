 ...
 */
export const transcribeAudio = async (request: TranscribeAudioRequest): Promise<TranscribeAudioResponse> => {
    try {
 ...
 */
export const getAudioTranscriptionStatus = async (transcriptionId: string): Promise<AudioSummary | null> => {
    try {
